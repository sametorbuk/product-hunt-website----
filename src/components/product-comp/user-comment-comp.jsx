    ...
    <>
      <div className="user-comment-component">
        <img
          ...
          src="https://ph-avatars.imgix.net/4438396/079fabcb-7d01-42d9-a98f-2fc7befce04e.png?auto=compress&codec=mozjpeg&cs=strip&auto=format&w=36&h=36&fit=crop&dpr=2"
          alt=""
        />
        ...
        <div className="user-comment-content">
          ...
          <p>
            If I have a photo of someone standing near the edge of the frame,
            can your AI figure out how to naturally extend the background
            without messing up the persons proportions? Kudos on the launch,
            amazing tool🥳
          </p>
